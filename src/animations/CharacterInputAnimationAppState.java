 ...
 * File: CharacterInputAnimationAppState.java
 * Description: This class maps user input to game actions allowing the 
 * game to respond to those user actions.
 */
...
public class CharacterInputAnimationAppState extends AbstractAppState implements AnalogListener, ActionListener{
    ...
    //Updated the InputMapping enum to include "Wave" and "SideKick" values
    ...
    //mappingNames string was updated to include "Wave" and "SideKick" value as well
    private String[] mappingNames = new String[]{InputMapping.Fire.name(), InputMapping.LeanFree.name(), InputAppState.InputMapping.LeanLeft.name(), InputAppState.InputMapping.LeanRight.name(),InputMapping.ToggleCover.name(), InputMapping.RotateLeft.name(), InputMapping.RotateRight.name(), InputMapping.LookUp.name(), InputMapping.LookDown.name(), InputMapping.StrafeLeft.name(),
        InputMapping.StrafeRight.name(), InputMapping.MoveForward.name(), InputMapping.MoveBackward.name(), ChaseCamera.ChaseCamUp, ChaseCamera.ChaseCamDown, ChaseCamera.ChaseCamMoveLeft, ChaseCamera.ChaseCamMoveRight, InputMapping.Jump.name(), InputMapping.Wave.name(), InputMapping.SideKick.name()};
    ...
    //addInputMappings was updated to map the "P" key to the "Wave" action
    //and the left mouse button to the "SideKick" event
    private void addInputMappings(){
        ...
        inputManager.addMapping(InputMapping.Wave.name(), new KeyTrigger(KeyInput.KEY_P));
